...
all_df = pd.read_csv("https://raw.githubusercontent.com/milaamaliad/Ecommerce-Public-DataAnalysis/main/dashboard/df.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv('https://raw.githubusercontent.com/milaamaliad/Ecommerce-Public-DataAnalysis/main/dashboard/geolocation.csv')
...
with st.sidebar:
    ...
    # Logo Image
    st.image("https://raw.githubusercontent.com/milaamaliad/Ecommerce-Public-DataAnalysis/main/dashboard/logo.png")
